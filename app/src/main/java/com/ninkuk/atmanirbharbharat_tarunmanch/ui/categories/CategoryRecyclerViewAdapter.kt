...
class CategoriesRecyclerViewAdapter(private val businessList: List<Business>) :
    RecyclerView.Adapter<CategoriesRecyclerViewAdapter.CategoryRecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryRecyclerViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action =
                CategoryListFragmentDirections.categoryListToBusiness(businessList[position])
